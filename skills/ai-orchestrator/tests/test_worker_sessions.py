...
class WorkerSessionTests(unittest.TestCase):
    ...
    def test_session_activity_uses_one_payload_shape_for_claude_and_codex(self):
        ...
        claude = worker_sessions.session_activity("claude", claude_path)
        codex = worker_sessions.session_activity("codex", codex_path)
    ...
    def test_unknown_tool_has_no_session_fallback(self):
        ...
        self.assertEqual(worker_sessions.session_activity("other", path), {})
        self.assertIsNone(worker_sessions.extract_session_text("other", path))
    ...
    def test_claude_activity_tracks_bare_assistant_row(self):
        ...
        activity = worker_sessions.session_activity("claude", path)
    ...
    def test_extract_session_text_reads_latest_vendor_answer(self):
        ...
        self.assertEqual(worker_sessions.extract_session_text("claude", claude_path), "latest Claude")
        self.assertEqual(worker_sessions.extract_session_text("codex", codex_path), "latest Codex")
